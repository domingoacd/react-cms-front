...
const CardBoxRows = ({ title, moreUrl, data }) => {
    ...
    const getCards = () => {
        return data.map(element => {
            return (
                <div key={element.id} className=" w-full md:w-30% flex flex-col md:flex-row gap-4 min-w-19r my-2 mx-auto md:mx-0">
                    ...
                    <div className="flex md:flex-col gap-3 w-full md:w-8/12 justify-between">
                        ...
                        <div className="hidden gap-4 text-xs md:flex">
                            <span>
                                <i className="far fa-thumbs-up text-secondary mr-2"></i>
                                {element.interactions.likes}
                            </span>
                            <span>
                                <i className="far fa-thumbs-down text-text-light mr-2"></i>
